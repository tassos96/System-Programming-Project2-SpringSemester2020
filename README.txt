...
Παράδειγμα εντολής εκτέλεσης script: ./create_infiles.sh diseasesFile countriesFile input_dir 5 50
Παράδειγμα εντολής εκτέλεσης: ./diseaseAggregator -w 3 -b 50 -i ./input_dir
